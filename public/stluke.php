...
<head>
    ...
    <title>St Luke Small Christian Community</title>
    <style>
        /* Css to style the table for storing members */
        table {
			margin: 0 auto;
            margin-left: 15%;
			font-size: large;
...
<body>
    <div class="groups-a">
        <ul>
            ...
            <li><a href="stmichael.php">St.Michael</a></li>
...
$sql = "SELECT * FROM lukemembers ORDER BY id DESC ";
...
// SQL query to select data from database
$sql = "SELECT * FROM lukeevents ORDER BY id DESC ";
$result = $mysqli->query($sql);
$mysqli->close();
?>
