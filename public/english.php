...
<head>
    ...
    <title>English Prayers</title>
    <style>
         h3{
            color: rgb(73, 71, 71);
            background-color: rgb(241, 152, 88);
        }
        body{
