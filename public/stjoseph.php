...
<head>
    ...
    <title>St Joseph Small Christian Community</title>
    <style>
        table {
			margin: 0 auto;
            margin-left: 15%;
...
$sql = "SELECT * FROM josephmembers ORDER BY id DESC ";
...
// SQL query to select data from database
$sql = "SELECT * FROM josephevents ORDER BY id DESC ";
$result = $mysqli->query($sql);
$mysqli->close();
?>
